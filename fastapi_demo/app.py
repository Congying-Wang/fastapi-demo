...
description = """
fastapi_demo API helps you do awesome stuff. 🚀
"""
...
app = FastAPI(
    ...
    terms_of_service="http://fastapi_demo.com/terms/",
    contact={
        "name": "Congying-Wang",
        "url": "http://fastapi_demo.com/contact/",
        "email": "Congying-Wang@fastapi_demo.com",
    },
    license_info={
        "name": "The Unlicense",
