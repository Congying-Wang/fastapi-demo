...
# WARNING: Ensure imports from `fastapi_demo` comes after this line
from fastapi_demo import app, settings, db  # noqa
from fastapi_demo.cli import create_user, cli  # noqa
