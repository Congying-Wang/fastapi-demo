...
- 🎯 Entry points to execute your program using `python -m <fastapi_demo>` or `$ fastapi_demo` with basic CLI argument parsing.
...
[![codecov](https://codecov.io/gh/Congying-Wang/fastapi-demo/branch/main/graph/badge.svg?token=fastapi-demo_token_here)](https://codecov.io/gh/Congying-Wang/fastapi-demo)
[![CI](https://github.com/Congying-Wang/fastapi-demo/actions/workflows/main.yml/badge.svg)](https://github.com/Congying-Wang/fastapi-demo/actions/workflows/main.yml)

Awesome fastapi_demo created by Congying-Wang

## Install

from source
```bash
git clone https://github.com/Congying-Wang/fastapi-demo fastapi_demo
cd fastapi_demo
make install
```
...
```bash
pip install fastapi_demo
```

## Executing

```bash
$ fastapi_demo run --port 8080
```

or

```bash
python -m fastapi_demo run --port 8080
```

or

```bash
$ uvicorn fastapi_demo:app
```
...
```bash
❯ fastapi_demo --help
Usage: fastapi_demo [OPTIONS] COMMAND [ARGS]...
...
```bash
❯ fastapi_demo create-user --help
Usage: fastapi_demo create-user [OPTIONS] USERNAME PASSWORD
...
```bash
fastapi_demo create-user admin admin --superuser
```
...
Run with `fastapi_demo run` and access http://127.0.0.1:8000/docs

![](https://raw.githubusercontent.com/rochacbruno/fastapi-project-template/master/docs/api.png)


**For some api calls you must authenticate** using the user created with `fastapi_demo create-user`.
...
-----------------------------------------------------
fastapi_demo/__init__.py              4      0   100%
fastapi_demo/app.py                  16      1    94%
fastapi_demo/cli.py                  21      0   100%
fastapi_demo/config.py                5      0   100%
fastapi_demo/db.py                   10      0   100%
fastapi_demo/models/__init__.py       0      0   100%
fastapi_demo/models/content.py       47      1    98%
fastapi_demo/routes/__init__.py      11      0   100%
fastapi_demo/routes/content.py       52     25    52%
fastapi_demo/routes/security.py      15      1    93%
fastapi_demo/routes/user.py          52     26    50%
fastapi_demo/security.py            103     12    88%
-----------------------------------------------------
TOTAL                               336     66    80%
...
> `dynaconf_merge` is a boolean that tells if the settings should be merged with the default settings defined in fastapi_demo/default.toml.
